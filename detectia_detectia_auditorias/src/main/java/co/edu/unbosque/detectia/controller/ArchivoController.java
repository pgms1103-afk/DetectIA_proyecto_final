...
//	}
    ...
    @PostMapping(value = "/analizar", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
    public ResponseEntity<?> analizar(@RequestParam String nombre,
        ...
        try {
            ...
            // Usamos el método con auditoría
            Archivo archivoGuardado = archivoSer.createAndReturnConAuditoria(
                    nuevo, request.getRemoteAddr(), request.getHeader("User-Agent"));
