...
public class ResultadoIAService implements CRUDoperation<ResultadoIADTO> {
	...
	public List<ResultadoIADTO> getResultadosByArchivo(String nombreArchivo) {
		Optional<Archivo> archivoEncontrado = archivoRepo.findByNombre(nombreArchivo);
	...
	public List<ResultadoIADTO> getResultadosByCorreo(String correo){
	    ...
	    List<ResultadoIA> entityList = resultadoIARepo.findByArchivo_Usuario_Correo(correo);
